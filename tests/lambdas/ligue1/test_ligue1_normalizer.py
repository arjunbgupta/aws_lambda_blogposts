...
import json
import pandas as pd
from lambdas.ligue1.ligue1_normalizer import Ligue1Normalizer
...
def config_path(request):
    ...
    return os.path.join(
        request.config.rootdir, "lambdas", "ligue1", "config", "normalizer_config.yaml"
    )
